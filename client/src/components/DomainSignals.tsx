...
const REFERENCE_LINKS: Record<string, { url: string; label: string }> = {
  ...
  "permissions policy": { url: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Headers/Permissions-Policy", label: "MDN: Permissions-Policy" },
  "web application firewall": { url: "https://www.cloudflare.com/learning/ddos/glossary/web-application-firewall-waf/", label: "Cloudflare: What is a WAF?" },
  "waf": { url: "https://www.cloudflare.com/learning/ddos/glossary/web-application-firewall-waf/", label: "Cloudflare: What is a WAF?" },
  "certificate type": { url: "https://www.digicert.com/difference-between-dv-ov-and-ev-ssl-certificates", label: "DigiCert: DV vs OV vs EV" },
  "bug bounty": { url: "https://www.hackerone.com/vulnerability-management/what-bug-bounty", label: "HackerOne: What is a Bug Bounty?" },
