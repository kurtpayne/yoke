...
import { detectHosting, HOSTING_PATTERNS } from '@worker/actions/analyze/security';
...
describe('Hosting/CDN Detection', () => {
  ...
  it('should detect AWS from rDNS', () => {
    const ipInfo = { ip: '54.123.45.67', isp: null, org: null, asn: null, city: null, country: null, country_code: null, lat: null, lon: null, reverse_dns: 'ec2-54-123-45-67.compute-1.amazonaws.com', ipv6: null };
